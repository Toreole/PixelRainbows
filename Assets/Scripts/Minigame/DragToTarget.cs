...
namespace Minigame
{
    public class DragToTarget : MinigameBaseClass
    {
        ...
        [SerializeField][Tooltip("Object that will restraint the drag of the object the player is dragging. Think of it as the corner of a box and place it on the top left")]
        private GameObject _leftRestraint;

        [SerializeField][Tooltip("Object that will restraint the drag of the object the player is dragging. Think of it as the corner of a box and place it on the bottom right")]
